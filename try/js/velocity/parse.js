...
break;
case 73: this.$ = {type: "property", id: $$[$0]}; if ($$[$0].type === 'content') this.$ = $$[$0]; 
break;
...
case 80: this.$ = $$[$0]; 
break;
case 81: this.$ = {type: 'content', value: $$[$0-1] + $$[$0]}; 
break;
case 82: this.$ = $$[$0-1]; 
break;
case 83: this.$ = $$[$0-1]; 
break;
case 84: this.$ = {type: "content", value: $$[$0-2] + $$[$0-1].value + $$[$0]}; 
break;
case 85: this.$ = {type: "content", value: $$[$0-1] + $$[$0]}; 
break;
case 86: this.$ = {type: "content", value: $$[$0-1] + $$[$0]}; 
break;
case 87: this.$ = $$[$0]; 
break;
